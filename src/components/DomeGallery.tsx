...
const DEFAULT_IMAGES: ImageItem[] = [
  {
    src: '/media/domeGallery/one.webp',
    alt: 'Gallery image one'
  },
  {
    src: '/media/domeGallery/second.webp',
    alt: 'Gallery image two'
  },
  {
    src: '/media/domeGallery/third.webp',
    alt: 'Gallery image three'
  },
  {
    src: '/media/domeGallery/four.webp',
    alt: 'Gallery image four'
  },
  {
    src: '/media/domeGallery/five.webp',
    alt: 'Gallery image five'
  },
  {
    src: '/media/domeGallery/six.webp',
    alt: 'Gallery image six'
  },
  {
    src: '/media/domeGallery/seven.webp',
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer bg-[#1a1a1a] transition-transform duration-300"
                    role="button"
                    tabIndex={0}
