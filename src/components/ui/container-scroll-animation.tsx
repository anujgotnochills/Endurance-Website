...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="relative z-10 max-w-6xl -mt-3 sm:-mt-8 md:-mt-12 mx-auto aspect-video w-full border-4 border-[#6C6C6C] p-2 sm:p-2.5 md:p-6 bg-[#222222] rounded-[24px] md:rounded-[30px] shadow-2xl"
    >
